...
function extractFullName(arr){
    let fullNames = arr.map(function(obj) {
...
function find(arr, searchValue) {
    ...
    })[0]; //because its putting all into a new array, we're asking for the value in the new array with an index of 0. if there is nothing in the new array, index of 0 will be undefined
}
